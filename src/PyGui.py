...
from PyQt5.QtWidgets import (
    ...
    QCheckBox, QScrollArea, QGroupBox, QFrame, QMenuBar, QAction,
    QMessageBox, QFileDialog, QDialog, QLineEdit, QRadioButton,
...
class HarvesterThread(QThread):
    ...
    def run(self):
        try:
            # Build command
            harvester_script = 'getcounter.py'  # Fixed to getcounter.py
...
class SushiConfigDialog(QDialog):
    def __init__(self, parent=None):
        ...
        # always_include_header_metric_types (checkbox)
    ...
    def load_sushi_config(self):
        """Load configuration from sushiconfig.py"""
        config = {}
        try:
            # Read the sushiconfig.py file
    ...
    def save_changes(self):
        """Save changes back to sushiconfig.py"""
        try:
...
class SushiHarvesterGUI(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # Progress log - only raw CLI output
