...
class ConfigManager:
    def __init__(self):
        # Find sushiconfig.py more reliably
        self.config_file = self._find_config_file()

    def _find_config_file(self):
        """Find sushiconfig.py in expected locations"""
    ...
    def load_config(self):
        """Load configuration from sushiconfig.py file"""
        config = {
    ...
    def save_config(self, config_data):
        """Save configuration to sushiconfig.py"""
        try:
